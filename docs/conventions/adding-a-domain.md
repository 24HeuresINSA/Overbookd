...
See [`docs/architecture/api-anatomy.md`](../architecture/api-anatomy.md) for the slice anatomy.
...
Replace the placeholder in `docs/business/domains/<name>.md` with a real explanation of the domain — purpose, key concepts, lifecycle, where the code lives. Update `docs/business/README.md` to include the new domain in the index. Tick the "Updated /docs if relevant" checkbox in your MR.
