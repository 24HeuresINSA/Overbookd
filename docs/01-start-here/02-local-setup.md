...
The full annotated table is in [`docs/06-reference/scripts.md`](../06-reference/scripts.md).
...
- [`docs/05-operations/local-dev-gotchas.md`](../05-operations/local-dev-gotchas.md) — deeper dive into common pitfalls
