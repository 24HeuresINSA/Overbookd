...
Domain code without a UT is a bug. Write the test **first** if you can — see [`docs/conventions/testing.md`](../conventions/testing.md).
...
This repo uses **Conventional Commits** enforced by a pre-commit hook. Allowed types are documented in [`docs/conventions/commits-and-branches.md`](../conventions/commits-and-branches.md).
...
- Tests at the right layer ([testing.md](../conventions/testing.md)).
...
- [`docs/conventions/adding-a-domain.md`](../conventions/adding-a-domain.md) — when a feature warrants a brand-new bounded context
- [`docs/conventions/adding-an-api-endpoint.md`](../conventions/adding-an-api-endpoint.md)
- [`docs/conventions/adding-a-web-page.md`](../conventions/adding-a-web-page.md)
- [`docs/conventions/merge-requests.md`](../conventions/merge-requests.md)
