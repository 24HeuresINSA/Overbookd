...
- [`docs/03-business/domains/festival-event.md`](./festival-event.md) — FAs request signage via inquiry requests
- [`docs/03-business/domains/logistic.md`](./logistic.md) — sister domain for gear
