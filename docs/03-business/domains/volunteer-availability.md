...
- [`docs/03-business/domains/assignment.md`](./assignment.md) — what consumes this data
- [`docs/03-business/domains/festival-event.md`](./festival-event.md) — what FTs need to be matched against
