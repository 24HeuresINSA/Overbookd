...
- [`docs/03-business/domains/festival-event.md`](./festival-event.md) — what produces FTs ready for assignment
- [`docs/03-business/domains/volunteer-availability.md`](./volunteer-availability.md) — where the input availability comes from
- [`docs/03-business/domains/access-manager.md`](./access-manager.md) — teams and their permissions
