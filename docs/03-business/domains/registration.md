...
- [`docs/03-business/domains/access-manager.md`](./access-manager.md) — teams and permissions assigned after registration
- [`docs/03-business/domains/contribution.md`](./contribution.md) — paying to become an adhérent
