...
- [`docs/02-architecture/api-anatomy.md`](../../02-architecture/api-anatomy.md) — how the guards plug into NestJS
- [`docs/04-conventions/adding-an-api-endpoint.md`](../../04-conventions/adding-an-api-endpoint.md) — how to add a `@Permission(...)` to a new route
