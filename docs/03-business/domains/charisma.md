...
- [`docs/03-business/domains/personal-account.md`](./personal-account.md) — separate concept (money, not points)
- [`docs/03-business/domains/festival-event.md`](./festival-event.md) — where shifts happen during the festival
