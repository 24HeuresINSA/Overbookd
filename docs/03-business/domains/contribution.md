...
- [`docs/03-business/domains/personal-account.md`](./personal-account.md) — separate intra-festival economy
- [`docs/03-business/domains/registration.md`](./registration.md) — becoming a member in the first place
