...
The `release:*` family is documented in [`docs/operations/release-process.md`](../operations/release-process.md). Quick reference:
...
- [`docs/operations/release-process.md`](../operations/release-process.md)
- [`docs/conventions/testing.md`](../conventions/testing.md)
- [`docs/start-here/02-local-setup.md`](../start-here/02-local-setup.md)
