...
- [`docs/business/domains/contribution.md`](./contribution.md) — yearly fee, distinct from per-festival transactions
- [`docs/business/domains/charisma.md`](./charisma.md) — point-based reward system
