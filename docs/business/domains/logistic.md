...
- [`docs/business/domains/festival-event.md`](./festival-event.md) — FAs/FTs raise inquiry requests
- [`docs/business/domains/signa.md`](./signa.md) — sister domain for signage
