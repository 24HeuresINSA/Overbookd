...
UTs are **mandatory** here — see [`docs/conventions/testing.md`](../conventions/testing.md). If your domain change has no UT, the MR is incomplete.
...
- [`docs/architecture/domain-driven-layout.md`](./domain-driven-layout.md) — anatomy of a domain folder
- [`docs/conventions/adding-a-domain.md`](../conventions/adding-a-domain.md) — recipe for a brand-new bounded context
