...
For "what does each one mean in festival terms" see [`docs/business/`](../business/README.md).
...
The recipe lives in [`docs/conventions/adding-a-domain.md`](../conventions/adding-a-domain.md).

## See also

- [`docs/architecture/dependency-hierarchy.md`](./dependency-hierarchy.md)
- [`docs/business/`](../business/README.md) — what each domain represents in festival terms
- [`docs/conventions/testing.md`](../conventions/testing.md) — UT discipline in domains
