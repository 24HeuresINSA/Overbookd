...
For the why and the wider anatomy, read [`docs/02-architecture/web-anatomy.md`](../02-architecture/web-anatomy.md) first.
...
- [`docs/02-architecture/web-anatomy.md`](../02-architecture/web-anatomy.md)
