...
For the why and the wider anatomy, read [`docs/02-architecture/api-anatomy.md`](../02-architecture/api-anatomy.md) first.
...
- [`docs/02-architecture/data-model.md`](../02-architecture/data-model.md)
- [`docs/04-conventions/adding-a-domain.md`](./adding-a-domain.md)
