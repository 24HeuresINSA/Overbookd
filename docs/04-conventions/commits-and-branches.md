...
- [`docs/04-conventions/merge-requests.md`](./merge-requests.md) — opening, reviewing, and merging
- [`docs/05-operations/release-process.md`](../05-operations/release-process.md) — how versions get bumped from these commits
