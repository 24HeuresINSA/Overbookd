...
- **Layering:** No imports that violate the [dependency hierarchy](../02-architecture/dependency-hierarchy.md).
...
- The release flow happens separately — see [`05-operations/release-process.md`](../05-operations/release-process.md).

## See also

- [`docs/04-conventions/commits-and-branches.md`](./commits-and-branches.md)
