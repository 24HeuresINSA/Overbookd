...
For the deeper "schema → domain mapping" view, see [`docs/architecture/data-model.md`](../architecture/data-model.md).
...
- [`docs/architecture/data-model.md`](../architecture/data-model.md) — schema overview and domain mapping
- [`docs/operations/deployment-topology.md`](./deployment-topology.md)
