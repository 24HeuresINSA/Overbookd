...
This mirrors the local dev topology (see [`docs/architecture/request-lifecycle.md`](../architecture/request-lifecycle.md)) — that's intentional, so what you debug locally maps directly to what runs in prod.
...
- [`docs/operations/database.md`](./database.md) — backups and restore
- [`docs/operations/release-process.md`](./release-process.md) — how releases are cut
- [`docs/architecture/request-lifecycle.md`](../architecture/request-lifecycle.md) — the same topology for local dev
