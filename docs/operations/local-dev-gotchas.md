...
> _Who it's for:_ Anyone whose local dev is broken in a way that isn't covered in [`docs/start-here/05-troubleshooting.md`](../start-here/05-troubleshooting.md).
...
**Fix:** Import the rootCA into Firefox specifically — see [`docs/start-here/02-local-setup.md` → Firefox](../start-here/02-local-setup.md#firefox-any-os).
...
**Fix:** Add explicit hosts entries — see [`docs/start-here/02-local-setup.md` → If `*.traefik.me` does not resolve](../start-here/02-local-setup.md#verify-it-works).
...
- [`docs/start-here/05-troubleshooting.md`](../start-here/05-troubleshooting.md) — first-week errors
