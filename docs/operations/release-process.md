...
- [`docs/conventions/commits-and-branches.md`](../conventions/commits-and-branches.md) — Conventional Commits rules
- [`docs/operations/deployment-topology.md`](./deployment-topology.md) — what happens after the tag is pushed
