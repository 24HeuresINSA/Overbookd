...
export class FaCommentService {
    ...
    createFAComments(faId: number, createFaCommentDto: CreateFaCommentDto[]): Promise<Prisma.BatchPayload | null> {
        ...
        return this.prisma.fA_Comment.createMany({data: faComments,skipDuplicates: true});
    }
