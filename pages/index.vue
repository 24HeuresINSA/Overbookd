<template>
  <div>
          ...
          <v-simple-table>
            <template v-slot:default>
              ...
              >
                ...
                <td v-if="notification.type === 'friendRequest'" style="display: flex; justify-content: space-between">
                  <v-btn ><v-icon>mdi-account-check</v-icon></v-btn>
                  <v-btn ><v-icon>mdi-account-cancel</v-icon></v-btn>
                </td>
                <td v-else-if="notification.type === 'form'">
                <v-btn><v-icon>mdi-link</v-icon></v-btn>
              </td>
              </tr>
              </tbody>
            </template>
    ...
    <v-snackbar
        ...
        :timeout="5000"
    >
      votre demande d'ami a ete envoye
    </v-snackbar>
...
export default {
  ...
  methods: {
    ...
    async broadcast(){
      ...
      await this.$axios.put('/user/notification', this.notification);
    },
