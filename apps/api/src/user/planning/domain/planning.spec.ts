...
const antoninContact = { id: 3, name: "antonin", phoneNumber: "06010203003" };
const valerie = { id: 4, name: "valerie" };
const lina = { id: 5, name: "lina" };
const elodie = { id: 6, name: "elodie" };
const elodieContact = { id: 6, name: "elodie", phoneNumber: "0601020306" };
...
const anaContact = { id: 11, name: "ana", phoneNumber: "0601020311" };
