        ...
        >
          ...
          <template #item.reviews="{ item }">
            <v-chip-group id="reviewers" column>
              <v-chip v-for="reviewer of reviewers" :key="reviewer.code" :class="getReviewerStatus(item, reviewer)" small>
...
import { TaskFilters, findReviewStatus } from "~/utils/festival-event/festival-task/festival-task.filter";
