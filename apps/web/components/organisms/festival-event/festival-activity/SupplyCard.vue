<template>
  <v-card>
    ...
    <v-card-subtitle>
      Précise tes besoins en électricité : 1 ligne par type d'appareil.<br />
      Si ton animation a besoin d'eau, renseigne le débit dont tu as besoin et
      comment l'évacuer.<br />
