...
> **English deep-dive:** [`docs/02-architecture/web-anatomy.md`](../../docs/02-architecture/web-anatomy.md)
...
- [`docs/01-start-here/02-local-setup.md`](../../docs/01-start-here/02-local-setup.md) — booting the web locally
- [`docs/04-conventions/adding-a-web-page.md`](../../docs/04-conventions/adding-a-web-page.md) — recipe for new pages
